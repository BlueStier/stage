...
$route['cms/createPersonnae'] = 'cms/createPersonnae/';
$route['cms/validatePersonnae'] = 'cms/validatePersonnae/';
$route['cms/validUpPersonnae'] = 'cms/validUpPersonnae/$1';
$route['cms/deletePersonnae/(:num)'] = 'cms/deletePersonnae/$1';
$route['cms/updatePersonnae/(:num)'] = 'cms/updatePersonnae/$1';
...
$route['cms/updateSupHome'] = 'cms/updateSupHome';
...
$route['cms/consultvox'] = 'cms/consultvox';
$route['cms/barre_de_recherche/(:any)/(:any)/(:num)'] = 'cms/barre_de_recherche/$1/$2/$3';
$route['cms/enregistre_mot/(:num)'] = 'cms/enregistre_mot/$1';
$route['cms/dodo'] = 'cms/dodo';
$route['cms/(:any)'] = 'cms/view/$1';
$route['cms'] = 'cms';
$route['login'] = 'login';
$route['login/connect'] = 'login/connect';
$route['login/mdp'] = 'login/mdp';
...
$route['pages/article_a_voir/(:num)'] = 'pages/article_a_voir/$1';
