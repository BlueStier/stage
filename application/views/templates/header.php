...
<link rel='stylesheet' id='images-blue-css'  href='<?php echo base_url();?>assets/css/skins/blue/images.css' type='text/css' media='all' />
<link rel='stylesheet' id='blue-css'  href='<?php echo base_url();?>assets/css/skins/blue/style.css' type='text/css' media='all' />
...
<div id="Wrapper">
	...
	<div id="Top_bar">
	 ...
	 ?>
							...
							<li class="menu-item  menu-item-has-children mfn-megamenu-cols-5"><a class="mfn-megamenu-title" href="<?php /*construction du lien en fonction du chemin en bdd*/ echo base_url().$sub['path'];?>"><span><?php echo $sub['nom']; ?></span></a>
                            <ul class="sub-menu mfn-megamenu mfn-megamenu-5">
