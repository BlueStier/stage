...
<head>
  ...
  <!-- iCheck -->
  <link rel="stylesheet" href="<?php echo base_url();?>/assets/cms/plugins/iCheck/square/blue.css">
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Admin</b>Oignies</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="../../index2.html" method="post">
      <div class="form-group has-feedback">
        <input type="name" class="form-control" placeholder="Nom" required>
...
<!-- iCheck -->
<script src="<?php echo base_url();?>/assets/cms/plugins/iCheck/icheck.min.js"></script>
<script>
  $(function () {
    $('input').iCheck({
