...
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>/asses/site/course-master/styles/main_styles.css">
...
<div class="super_container">
	...
	<header class="header d-flex flex-row">
		<div class="header_content d-flex flex-row align-items-center">
			...
			<div class="logo_container">
				<div class="logo">
					...
					<a href="<?php echo base_url();?>">Oignies</a>
				</div>
			</div>
		...
		<div class="header_side d-flex flex-row justify-content-center align-items-center">
			<img src="<?php echo base_url();?>/assets/site/course-master/ images/phone-call.svg" alt="">
