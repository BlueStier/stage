      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url();?>/assets/site/img/about/Fabienne-Dupuis.gif" class="user-image" alt="User Image">
              <span class="hidden-xs">Fabienne Dupuis</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-success">
            ...
            <div class="box-body chat" id="chat-box">
              ...
              <!-- chat item -->
              <div class="item">
                <img src="<?php echo base_url();?>/assets/cms/dist/img/user2-160x160.jpg" alt="user image" class="offline">
