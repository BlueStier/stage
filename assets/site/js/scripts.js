(function($){
	...
	function size_rapide(){
	var size_search = parseInt($('#search2').css('width'), 10);
	var size = size_search -30;
	var Lscreen = parseInt(window.innerHeight, 10);    
	if(Lscreen < 959){
		$('#rapide').css('width', size);		
	}
	}
